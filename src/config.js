...
module.exports = {
  ...
  bot: {
    ...
    message: process.env.PLUSH_BOT_MESSAGE || 'Welcome to Plush! Beta. Notice anything strange or have a suggestion? Message me here or send an email to hellohotchiwawa+support@gmail.com :)',
  },
